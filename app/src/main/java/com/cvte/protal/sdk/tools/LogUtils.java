...
public class LogUtils {
    ...
    public static void LOGD(final String tag, String message) {
        ...
        if (CloudConfig.DEBUG || Log.isLoggable(tag, Log.DEBUG)) {
            message = avoidNullMessage(message);
            Log.d(tag, message);
        }
    }
    ...
    public static void LOGV(final String tag, String message) {
        //noinspection PointlessBooleanExpression,ConstantConditions
        if (CloudConfig.DEBUG && Log.isLoggable(tag, Log.VERBOSE)) {
            message = avoidNullMessage(message);
            Log.v(tag, message);
        }
    }
    ...
    private static String avoidNullMessage(String message) {
        if (message == null) {
            return "null";
        }
        return message;
